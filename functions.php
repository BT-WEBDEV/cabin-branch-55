...
function gka_theme_scripts() {
	...
	wp_enqueue_script( 'Swiper', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/6.4.15/swiper-bundle.min.js', array(), '6.4.15', true );
	wp_enqueue_script( 'Fancybox', 'https://cdn.jsdelivr.net/npm/@fancyapps/ui/dist/fancybox.umd.js', array(), '4', true );
...
function gka_theme_styles() {
	...
	wp_enqueue_style( 'Swiper', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/6.4.15/swiper-bundle.min.css' );
...
/**
 * Implement the NextGen Gallry Slider
 */
